...
## Shared Directory
Follow [this guide](../guest-support/linux.md#macos-virtiofs) to enable VirtioFS directory sharing. We recommend using `/media/share` as the mount point.
...
Then, follow [this guide](../advanced/rosetta.md) to install Rosetta.
