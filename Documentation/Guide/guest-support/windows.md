...
In order to use all the features of UTM Pro, you should install the Windows Guest Tools in the virtual machine guest. The tools support Windows XP or higher on x86_64 (excluding Windows XP), i386, and arm64 builds.

## Installation

### Windows 10 and higher
If the guest tools ISO is mounted on a second CD drive, then it can be installed automatically during Windows Setup.
1. In the UTM Pro new virtual machine wizard, make sure to select "Windows"
...
**iOS**
1. [Open the action menu](../basics/actions.md) and select "Install Windows Guest Tools..."
2. Wait for the tools to finish downloading and it should be automatically mounted on the last removable drive.
3. Start the virtual machine.

**macOS**
1. Start the virtual machine.
2. [On the toolbar click the CD icon](../basics/controls.md) and select "Install Windows Guest Tools..."
3. Wait for the tools to finish downloading and it should be automatically mounted on the last removable drive.

4. Once Windows starts up and you are logged in, open "My Computer" and find the CD drive labeled "UTM Pro".
...
## SPICE WebDAV
If [QEMU SPICE WebDAV directory sharing](../settings-qemu/sharing.md#spice-webdav) is enabled, you can access it from "My Computer" as a network drive.
