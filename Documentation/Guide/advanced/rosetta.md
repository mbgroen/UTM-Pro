...
## Enable Rosetta
You can enable Rosetta by checking "Enable Rosetta (x86_64 Emulation)" in the wizard when setting up a Linux virtual machine. If you did not do this, you can go to the [Virtualization](../settings-apple/virtualization.md#macos-13-rosetta) tab and check "Enable Rosetta on Linux (x86_64 Emulation)".
