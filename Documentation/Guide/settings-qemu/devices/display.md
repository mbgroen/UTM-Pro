...
See [this page](../../advanced/multiple-displays.md) for more details on setting up multiple displays.
...
## Auto Resolution
This enables automatic resolution changing when the window size changes. Guest support is required. See [this page](../../guest-support/dynamic-resolution.md) for more details.
