...
To use UTM Pro server on macOS, you must be on version 4.5.2 or higher. Currently, only QEMU backend virtual machines are supported.

## Getting Started
To open UTM Pro server, you can either select the "Server" button from the home screen or the "UTM Pro Server" option from the "Window" menu.

[![](../assets/images/macos-server-button.png)](../assets/images/macos-server-button.png)
[![](../assets/images/macos-server-window.png)](../assets/images/macos-server-window.png)

## Usage

[![](../assets/images/macos-server-window.png)](../assets/images/macos-server-window.png)

1. This enables UTM Pro server when checked. By default, UTM Pro server will not start automatically and this must be checked on every launch of UTM Pro. If you want to automatically start UTM Pro server on launch, [you can change the preferences](../preferences/macos.md#automatically-start-utm-server).
...
## Settings
UTM Pro server settings can be found in [Preferences](../preferences/macos.md#server).
...
[![](../assets/images/macos-server-prompt.png)](../assets/images/macos-server-prompt.png)
